from jobs import q, rd_jobs, update_job_status, stock_and_sales_df, products_df
import redis
import pandas as pd
import time
...
def execute_job(jid):
    ...
    store_input = rd_jobs.hget(jid, 'store_input')
    start_date = rd_jobs.hget(jid, 'start_date')
    end_date = rd_jobs.hget(jid, 'end_date')
